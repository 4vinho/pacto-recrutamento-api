...
import br.com.pacto.recrutamento.app.usuario.RecuperacaoSenhaPort;
...
public class RecuperacaoSenhaJpaAdapter implements RecuperacaoSenhaPort {
    ...
    public RecuperacaoSenhaJpaAdapter(TokenRecuperacaoSenhaJpaRepository repository) { this.repository = repository; }
