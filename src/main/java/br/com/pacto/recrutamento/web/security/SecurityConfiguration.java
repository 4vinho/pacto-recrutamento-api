...
public class SecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(
        ...
        http.csrf()
                ...
                .antMatchers(HttpMethod.DELETE, "/templates-vaga/**").hasRole(ADMINISTRADOR)
                .antMatchers("/templates-vaga/**").hasAnyRole(ADMINISTRADOR, RESPONSAVEL_VAGA)
                ...
                .antMatchers(HttpMethod.PATCH, "/candidaturas/*/status")
                     .hasAnyRole(ADMINISTRADOR, RESPONSAVEL_VAGA)
                .antMatchers(HttpMethod.DELETE, "/vagas/**").hasRole(ADMINISTRADOR)
